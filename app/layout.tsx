...
const RootLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <html lang="en" className={clsx("dark", graphik.variable)}>
      <body className="antialiased max-w-3xl flex flex-col md:flex-row mx-4 mt-8 md:mx-auto">
        <main className="flex-auto min-w-0 mt-6 mb-20 flex flex-col px-2 z-0 overflow-x-hidden">
          <Providers>
            <Navbar />
            <NightSky />
            {children}
