        ...
        {experiences.map((item, i) => (
          ...
          >
            ...
            <button
              ...
              data-collapse-toggle={`drawer-${i}`}
              className="w-full mt-1 items-start flex flex-col md:flex-row md:items-center justify-between gap-2"
            >
            ...
            <p
              id={`drawer-${i}`}
              className="border-l-[2px] ml-[15px] pl-[15px] hidden text-base font-normal mt-2 text-gray-500 dark:text-gray-400 border-neutral-200 dark:border-neutral-700"
            >
              {item.desc}
            </p>
          </li>
